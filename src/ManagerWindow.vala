...
/*        private const Gtk.ToggleActionEntry _main_win_toggle_actions[] = {
        ...
        private guint           _statusbar_ctx;
        private guint           _statusbar_ctx2;
...
//~             action_group.add_radio_actions  (_main_win_sort_by_actions, 0, _on_sort_by);
            ...
            _toolbar = ui.get_widget ("/toolbar") as Gtk.Toolbar;
            ...
            gtk_toolbar_insert (GTK_TOOLBAR (this.toolbar), toolitem, 2);
            ...
            /*** set up history menu 
            this.nav_history = fm_nav_history_new ();
            this.history_menu = gtk_menu_new ();
